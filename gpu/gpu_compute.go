...
func NewComputePhysics(planet *core.VoxelPlanet) (*ComputePhysics, error) {
...
func (cp *ComputePhysics) InitializePlateTectonics(plateManager *simulation.PlateManager) error {
