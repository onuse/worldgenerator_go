...
func NewWindowsGPUBufferManager(planet *VoxelPlanet) (*WindowsGPUBufferManager, error) {
	// Count totals
	totalVoxels := 0
	totalLonCounts := 0
	...
	mgr.shellData = make([]ShellMetadataGPU, mgr.shellCount)
...
func (mgr *WindowsGPUBufferManager) UpdateFromPlanet(planet *VoxelPlanet) {
...
func (mgr *WindowsGPUBufferManager) UpdateToPlanet(planet *VoxelPlanet) {
...
func (mgr *WindowsGPUBufferManager) updateShellMetadata(planet *VoxelPlanet) {
	voxelOffset := 0
	lonCountOffset := 0
